...
<!-- CSS Libraries -->
<link rel="stylesheet"
	href="./node_modules/selectric/public/selectric.css">
								...
								<form method="POST" action="registerAsCustomer">
									...
									<div class="row">
										<div class="form-group col-6">
											<label for="password" class="d-block">密码</label> <input
										...
										<div class="form-group col-6">
											<label for="password2" class="d-block">确认密码</label> <input
									...
									<div class="form-group">
										<div class="custom-control custom-checkbox">
											<input type="checkbox" name="agree"
												...
												class="custom-control-label" for="agree">我同意<a
												href="#">用户协议</a></label>
										</div>
									</div>
